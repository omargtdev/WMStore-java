...
public class WMModify extends JDialog {
	...
	public WMModify() {
		...
		btnClose.setBounds(335, 7, 89, 23); getContentPane().add(btnClose); btnSave = new JButton("Guardar"); btnSave.setBounds(335, 32, 89, 23);
